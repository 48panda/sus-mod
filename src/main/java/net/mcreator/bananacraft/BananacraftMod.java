 ...
 *
 */
package net.mcreator.bananacraft;
...
@Mod("bananacraft")
public class BananacraftMod {
	public static final Logger LOGGER = LogManager.getLogger(BananacraftMod.class);
	...
	public BananacraftMod() {
		BananacraftModTabs.load();
