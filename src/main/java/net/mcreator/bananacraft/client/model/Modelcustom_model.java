...
public class Modelcustom_model<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bananacraft", "modelcustom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LegL = partdefinition
				.addOrReplaceChild("LegL",
						CubeListBuilder.create().texOffs(60, 49).addBox(-3.0F, 0.0F, -3.0F, 7.0F, 9.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(86, 53).addBox(-3.0F, 9.0F, -5.0F, 7.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
						PartPose.offset(5.0F, 12.0F, 0.0F));
		PartDefinition LegR = partdefinition.addOrReplaceChild(
				"LegR", CubeListBuilder.create().texOffs(86, 42).addBox(-4.0F, 9.0F, -5.0F, 7.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(60, 34).addBox(-4.0F, 0.0F, -3.0F, 7.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.0F, 12.0F, 0.0F));
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(20, 8).addBox(-7.0F, -3.0F, -2.0F, 14.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)),
