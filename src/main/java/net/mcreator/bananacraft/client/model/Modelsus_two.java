...
public class Modelsus_two<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("bananacraft", "modelsus_two"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LegL = partdefinition
				.addOrReplaceChild("LegL",
						CubeListBuilder.create().texOffs(60, 49).addBox(2.0F, 0.0F, -3.0F, 7.0F, 9.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(86, 53).addBox(2.0F, 9.0F, -5.0F, 7.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 12.0F, 0.0F));
		PartDefinition LegR = partdefinition
				.addOrReplaceChild("LegR",
						CubeListBuilder.create().texOffs(86, 42).addBox(-9.0F, 9.0F, -5.0F, 7.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
								.texOffs(60, 34).addBox(-9.0F, 0.0F, -3.0F, 7.0F, 9.0F, 6.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 12.0F, 0.0F));
