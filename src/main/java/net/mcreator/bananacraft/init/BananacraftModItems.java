...
public class BananacraftModItems {
	...
	public static final RegistryObject<Item> RICK = REGISTRY.register("rick_spawn_egg",
			() -> new ForgeSpawnEggItem(BananacraftModEntities.RICK, -13422283, -8500438, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> CREWMATE = REGISTRY.register("crewmate_spawn_egg",
			() -> new ForgeSpawnEggItem(BananacraftModEntities.CREWMATE, -1, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	...
	public static final RegistryObject<Item> SUSPICIOUS_BLOCK = block(BananacraftModBlocks.SUSPICIOUS_BLOCK, CreativeModeTab.TAB_BUILDING_BLOCKS);
	...
	public static final RegistryObject<Item> CAKE = block(BananacraftModBlocks.CAKE, null);
