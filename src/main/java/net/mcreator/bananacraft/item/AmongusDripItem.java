...
public class AmongusDripItem extends RecordItem {
	public AmongusDripItem() {
		super(0, BananacraftModSounds.REGISTRY.get(new ResourceLocation("bananacraft:amongusdrip")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("red sus"));
	}
}
