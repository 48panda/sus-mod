...
public class BottleItem extends Item {
	public BottleItem() {
		super(new Item.Properties().tab(BananacraftModTabs.TAB_SUS_CREATIVE_TAB).stacksTo(1).rarity(Rarity.RARE)
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		ItemStack retval = new ItemStack(BananacraftModItems.BOTTLE.get());
