...
public class DreamItem extends RecordItem {
	public DreamItem() {
		super(0, BananacraftModSounds.REGISTRY.get(new ResourceLocation("bananacraft:dream")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Press play and speedrun"));
	}
}
