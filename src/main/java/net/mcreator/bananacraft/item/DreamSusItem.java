...
public class DreamSusItem extends RecordItem {
	public DreamSusItem() {
		super(0, BananacraftModSounds.REGISTRY.get(new ResourceLocation("bananacraft:dreamsus")),
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Keep out of earshot of Kieran"));
	}
}
